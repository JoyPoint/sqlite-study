...
int main()
{
    ...
    char * sql_iter = "select * from inserttest where ID = ?;";
...
//        printf("Next: %8d\n", i);
    ...
    printf("The insert_test_mem time is :%d us\n", waste);
 
    //---------------------------------------------------------------------    
    sqlite3_prepare(db, sql_iter, strlen(sql_iter), &stmt, 0);
...
//        printf("Next: %8d\n", i);
    ...
    waste = (end.tv_sec - begin.tv_sec) * 1000000 + (end.tv_usec - begin.tv_usec);
    printf("The iter_test_mem time is :%d us\n", waste);
    //---------------------------------------------------------------------
